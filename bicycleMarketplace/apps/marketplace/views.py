...
def register(request):
    if request.method == 'POST':
        ...
        return render(request, 'marketplace/base_register.html')
...
def login(request):
    if request.method == 'POST':
        ...
        return render(request, 'marketplace/base_login.html')
...
def createbike(request):
    if request.method == 'POST':
        ...
        # if it is an instance of a bike object (success), go back to page
        ...
        # else, add errors to flash messages and go back to page
            ...
            return render(request, 'marketplace/base_createBike.html', context)
...
def updatebike(request, bikeId):
    if request.method == 'POST':
        ...
        # else, add errors to flash messages and go back to page
            for error in result:
                messages.add_message(request, messages.ERROR, error)
            return redirect(reverse('bikes'))
        # to add reroute to edit bike page && pull bike to send as context dictionary
    ...
    # if GET
        ...
        return render(request, 'marketplace/base_edit.html', context)
